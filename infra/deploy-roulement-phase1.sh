...
echo "=== Arrêt API (boucle restart) pour copier les fichiers ==="
$COMPOSE stop api

echo "=== Copie des fichiers Roulement vers le conteneur api ==="

# Accounts — 0009 OBLIGATOIRE (parent de 0010, souvent absent en prod)
...
# Shifts — chaîne 0010 → 0011 → 0012 si absente en prod
