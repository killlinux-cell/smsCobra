...
const MethodChannel _androidCameraPermissionChannel =
    MethodChannel('com.cobrasecurity.israel/permissions');

/// Capture portrait vigile (enrôlement admin) : caméra arrière, qualité stricte, sans liveness.
class PortraitCapturePage extends StatefulWidget {
  const PortraitCapturePage({super.key});

  static Future<String?> capture(BuildContext context) async {
    return Navigator.of(context).push<String>(
      MaterialPageRoute(builder: (_) => const PortraitCapturePage()),
    );
  }

  @override
  State<PortraitCapturePage> createState() => _PortraitCapturePageState();
}

class _PortraitCapturePageState extends State<PortraitCapturePage> {
  ...
  String _qualityHint = "Cadrez le visage du vigile dans l'ovale.";
    ...
    try {
      ...
      setState(() {
        ...
        _error = suggestSettings
            ? "L'accès à la caméra est bloqué. Autorisez la caméra pour SMS Admin dans les paramètres Android."
  ...
  Future<void> _onCameraImage(CameraImage image) async {
    ...
    try {
      ...
      final ready = aligned && _stableGoodFrames >= 3;

      final nextHint = qualityIssue ?? _qualityHint;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Photo portrait vigile'),
      ),
      body: _error != null
          ? Center(
              child: Padding(
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Visage seul, de face, bien éclairé. Photo vérifiée à l\'enregistrement.',
                            textAlign: TextAlign.center,
                            style: TextStyle(
