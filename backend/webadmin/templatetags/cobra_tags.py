...
from reports.presence_display import report_presence_badge as _report_presence_badge


@register.simple_tag
def rapport_presence_badge(report):
    """Statut affiché : Présent seulement si début + fin pointés."""
    return _report_presence_badge(report)
